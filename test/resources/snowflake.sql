with cte_a62bd555_7a64_4a7c_8d4c_d7b4833e3cd2 as (
    SELECT
        ...
        CASE
            ...
            ELSE CAST (
                table_2558.column_2766 AS DECIMAL (38, 12)
            )
        END AS UH_C5591FBB04AAC642,
        CAST (
            table_2558.column_2665 AS DECIMAL (38, 12)
        ) AS UH_B1D0046780C85DFA,
        left (
            TO_DATE (table_2558.column_2604, 'DD/MM/YYYY'),
            7
...
cte_a8e7867c_f64f_4584_a1e2_a8a7d202b67d as (
    ...
    SELECT
        ...
        left (
            dateadd ('MONTH', 1, table_2552.column_2618),
            7
...
cte_b5bf0778_f4e1_465f_8bc7_3311ae5d6986 as (
    ...
    SELECT
        ...
        left (
            dateadd ('YEAR', 1, table_2552.column_2618),
            4
...
cte_9f66c556_1f65_4dc3_8e76_5a440580d83a as (
    ...
    SELECT
        ...
        (
            (
                table_2572.column_2630 / table_2572.column_2642
            ) / 2
...
cte_195838c3_9953_4579_94f5_35bc6a28b77f as (
    with cte_30adc85e_aba8_4f67_ae71_b8809fba22bb as (
        ...
        SELECT
            DISTINCT table_2547.column_2706 AS UH_7984D9BFB4F58688,
            ...
            ABS (
                CASE
                    WHEN CONCAT (
                        table_2547.column_2706,
                        table_2547.column_2594
                    ) = CONCAT (
                        table_2544.column_2775,
                        table_2544.column_2670
                    ) THEN 0
                    ELSE CAST (
                        table_2544.column_2677 AS DECIMAL (38, 12)
                    ) / CAST (
                        table_2547.column_2592 AS NUMBER (38)
                    )
                END
    ...
    cte_8398e7e0_efde_43bb_8816_a6dba1a06e24 as (
        ...
        SELECT
            DISTINCT table_2544.column_2837 AS UH_4FD7FFD09F4A91C5,
            SUM(
                ABS (
                    (
                        CASE
                            WHEN table_2547.column_2839 = RIGHT (
                                table_2544.column_2760,
                                3
                            ) THEN 0
                            ELSE CAST (
                                table_2547.column_2614 as DECIMAL (38, 12)
                            )
                        END
    ...
    SELECT
        DISTINCT table_2547.column_2706 AS UH_34CCFB90CCC6F02D,
        ...
        SUM (
            ABS (
                table_2544.column_2811 / CAST (
                    table_2547.column_2592 AS NUMBER
                )
            ) * 100
        ) OVER (
            PARTITION BY p6701.gt_ed6b6ee5_249e_4521_99ae_7a8f90e15e6c
...
cte_6a6b154f_57f0_429f_9e17_b9dce8fa501b as (
    with cte_923fa2ea_0085_4216_acb4_86a376b3e04a as (
        SELECT
            ...
            CAST (
                table_2564.column_2767 as DECIMAL (38, 3)
            ) AS UH_0964E7490E69F16D,
            table_2564.column_2704 AS UH_F07E6870C5573841,
            left (
                TO_DATE (table_2564.column_2644, 'DD/MM/YYYY'),
                7
    ...
    cte_c4c724f9_8c43_4447_844c_2a112abf3f23 as (
        ...
        SELECT
            ...
            left (
                dateadd ('YEAR', 1, table_2568.column_2576),
                4
    ...
    cte_da66352d_6ce2_49ce_8226_5a3bbb41c2a3 as (
        ...
        SELECT
            ...
            left (
                dateadd ('MONTH', 1, table_2568.column_2576),
                7
    ...
    SELECT
        ...
        (
            (
                table_2547.column_2579 / table_2560.column_2645
            ) - 1
        ) * 100 AS UH_4050277F68110E5E,
        table_2544.column_2652 AS UH_5CEE650DC0BAF835,
        (
            (
                table_2547.column_2579 / table_2544.column_2652
            ) - 1
...
SELECT
    ...
    (
        (
            table_2547.column_2616 / table_2544.column_2577
        ) - 1
    ...
    (
        (
            table_2547.column_2616 / table_2560.column_2585
        ) - 1
    ...
    (
        CASE
            ...
            ELSE CAST (
                table_2545.column_2578 AS DECIMAL (38, 12)
            )
        END * 100
